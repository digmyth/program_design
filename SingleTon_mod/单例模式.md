...
注意： obj  = SingleTon()实例化顺序为MyType.__new__,MyType.__init__, MyType.__call__, SingleTon.__new__, SingleTon.__init__，并且MyType.__call__的作用就是调用SingleTon.__new__,SingleTon.__init__
